...
-- -----------------------------------------------------
-- Table `Blog_Db`.`events`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Blog_Db`.`Blogs` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `Blog_Db`.`user_eevents`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Blog_Db`.`user_eevents` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATETIME NULL,
